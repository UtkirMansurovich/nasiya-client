    ...
    <div className="flex flex-col gap-7 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-2.5">
          ...
          <input
            type="text"
            defaultValue="50 000"
            className="bg-emerald-50/30 border border-emerald-200 text-emerald-700 text-lg rounded-xl focus:ring-4 focus:ring-emerald-100 focus:border-emerald-500 focus:bg-white block w-full p-3.5 transition-all outline-none font-bold"
          />
        </div>
        <div className="flex flex-col gap-2.5">
          <label className="text-sm font-bold text-gray-700 flex items-center gap-2">
          ...
          <select className="bg-gray-50/50 border border-gray-200 text-gray-800 text-sm rounded-xl focus:ring-4 focus:ring-emerald-100/50 focus:border-emerald-400 focus:bg-white block w-full p-3.5 transition-all outline-none font-medium h-13.5">
            <option>Naqd</option>
            <option>Karta</option>
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <input
          ...
          className="bg-gray-50/50 border border-gray-200 text-gray-800 text-sm rounded-xl focus:ring-4 focus:ring-emerald-100/50 focus:border-emerald-400 focus:bg-white block w-full p-3.5 transition-all outline-none font-medium placeholder-gray-400"
        />
      </div>
